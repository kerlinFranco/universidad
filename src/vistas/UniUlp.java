 ...
 * @author USURIO
 */
public class UniUlp extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
            ...
            escritorio.repaint();
            Alumno aluVista=new Alumno();
            aluVista.setVisible(true);
            escritorio.add(aluVista);
            escritorio.moveToFront(aluVista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UniUlp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public static AlumnoData conectar(){
